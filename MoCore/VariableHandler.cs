            ...
            else
            {
                ...
                switch (variable)
                {
                    case "version":
                        ...
                        break;
                    case "captain":
                        if (Svc.Get<MpSvc>().Captains == null || Svc.Get<MpSvc>().Captains.CaptainClient == null || Svc.Get<MpSvc>().Captains.CaptainClient.Player == null || Svc.Get<MpSvc>().Captains.CaptainClient.Player.DisplayName == null)
                            response = "";
                        else
